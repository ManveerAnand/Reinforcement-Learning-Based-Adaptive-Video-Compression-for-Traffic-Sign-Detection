...
def main():
    ...
    run_dir = Path('runs/train/yolo11s_cure_tsd_640/weights')
    ...
    print(f"  AMP:     ON (fp16 — stable at 640px)")
    ...
    results = model.train(
        ...
        batch=16,               # fits easily in 8GB VRAM at 640px
        device=0,
        workers=8,
        project='runs/train',
        name='yolo11s_cure_tsd_640',
        exist_ok=True,
        pretrained=True,
        optimizer='AdamW',
        verbose=True,
    ...
    print("=" * 60)
    print(f"  Best: runs/train/yolo11s_cure_tsd_640/weights/best.pt")
    print()
    print("  Next:")
    print("  python scripts/evaluate_fixed_B.py --model runs/train/yolo11s_cure_tsd_640/weights/best.pt")
    print("  python scripts/evaluate_rl_agent.py --model runs/train/yolo11s_cure_tsd_640/weights/best.pt")
